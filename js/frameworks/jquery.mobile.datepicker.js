(function( $, undefined ) {
    ...
    inline: false
      ...
      addMobileStyle: function(){
          ...
          .find(".ui-datepicker-header").addClass("ui-body-b ui-corner-top").removeClass("ui-corner-all").end()
          .find(".ui-datepicker-calendar th" ).addClass("ui-bar-b").end()
          .find(".ui-datepicker-calendar td" ).addClass("ui-body-b").end()
          .find(".ui-datepicker-calendar a.ui-state-active").addClass("ui-btn-active").end()
          .find(".ui-datepicker-calendar a.ui-state-highlight").addClass("ui-btn-up-b").end().find(".ui-state-disabled").css("opacity","1");
      }
    });
